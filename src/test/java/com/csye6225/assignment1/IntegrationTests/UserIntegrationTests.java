...
public class UserIntegrationTests {
    ...
    public void testCreateUser() {
        ...
        // Here, you can parse the getResponse.getBody() to validate specific user details
        // For simplicity, let's just check if the email (username) is present in the response
...
//        HttpEntity<String> getRequest = new HttpEntity<>(getHeaders);
//
//        ResponseEntity<String> getResponse = restTemplate.exchange(url, HttpMethod.GET, getRequest, String.class);
//
//        assertThat(getResponse.getStatusCode()).isEqualTo(HttpStatus.OK);
//        // Log for debugging
//        System.out.println("Get Response Body: " + getResponse.getBody());
...
//        // Here, you can parse the getResponse.getBody() to validate specific user details
//        // For simplicity, let's just check if the email (username) is present in the response
//        assertThat(getResponse.getBody()).contains("Mukul");
//    }
